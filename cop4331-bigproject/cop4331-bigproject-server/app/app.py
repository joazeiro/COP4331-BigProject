...
app.config['MAIL_USE_SSL'] = Truehero
...
def signup():
    ...
    # Otherwise, create a new instance of a user
        ...
        verification_link = f"https://geobooks-e802c07bfa62.herokuapp.com/verify/{token}"
...
def forgot_password():
    ...
    pwd_reset_link = f'https://geobooks-e802c07bfa62.herokuapp.com/reset-password'
